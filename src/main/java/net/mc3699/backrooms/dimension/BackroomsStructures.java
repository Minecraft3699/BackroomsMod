...
public class BackroomsStructures {
    ...
    public static final BackroomsStructureInfo HALLWAY_HUB = new BackroomsStructureInfo(
            ResourceLocation.fromNamespaceAndPath(BackroomsMod.MODID, "office_hallway_hub"), BlockPos.ZERO);
    ...
    public static final BackroomsStructureInfo HALLWAY_STRAIGHT = new BackroomsStructureInfo(
            ResourceLocation.fromNamespaceAndPath(BackroomsMod.MODID, "office_hallway_straight"),  BlockPos.ZERO);
    ...
    public static final BackroomsStructureInfo HALLWAY_CORNER = new BackroomsStructureInfo(
            ResourceLocation.fromNamespaceAndPath(BackroomsMod.MODID, "office_hallway_corner"), BlockPos.ZERO);
    ...
    public static final BackroomsStructureInfo HALLWAY_JUNCTION = new BackroomsStructureInfo(
            ResourceLocation.fromNamespaceAndPath(BackroomsMod.MODID, "office_hallway_t_junction"), BlockPos.ZERO);
