...
public class BackroomsL1 extends BackroomsLevel {
    ...
    public static void generateChunk(ChunkAccess chunk)
    {
        ...
        GenUtil.fillLayer(chunk, L1_FLOOR_LEVEL, BRBlocks.LVL1_CARPET.get());
        GenUtil.fillLayer(chunk, L1_CEILING_LEVEL, BRBlocks.LVL1_CEILING_TILE.get());
            ...
            if(!isChunkInNoise(chunk.getPos().x,chunk.getPos().z, GenNoise.EmptyAreaNoise, 0.25)) {
                GenUtil.generateBasicWallsWithExtension(chunk, L1_FLOOR_LEVEL, L1_CEILING_LEVEL, BRBlocks.LVL1_WALLPAPER.get(), 3,  Blocks.STONE_BRICKS);
            }
        carve(chunk);
    }
